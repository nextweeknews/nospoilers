Include detailed but plain-language comments within the codebase when adding or changing sections, focusing on explanations regarding the functions of the current code rather than explanations regarding changes. Generated summaries should include plain-language descriptions of the additions or changes.
