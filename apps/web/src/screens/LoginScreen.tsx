                ...
                <div style={phoneInputGroup(theme)}>
                  <div style={countrySelectWrapper} ref={countrySelectRef}>
                    <button
                      ...
                      style={countrySelectTrigger(theme)}
              ...
              <>
                ...
                <div style={{ display: "grid", gap: 6 }}>
                  ...
                  <small style={{ color: theme.colors.textSecondary, textAlign: "center" }}>
                    Already have an account? Sign in with your existing email and password.
                  </small>
                </div>
                ...
                <div style={{ display: "grid", gap: 6 }}>
                  ...
                  <small style={{ color: theme.colors.textSecondary, textAlign: "center" }}>
                    New here? Create an account with your email and password.
                  </small>
                  {legalDisclosure}
                </div>
              </>
